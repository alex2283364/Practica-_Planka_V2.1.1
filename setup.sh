...
if [ ! -d "client" ] || [ ! -d "server" ]; then
    ...
    rsync -av --exclude='.git' --exclude='docker-compose.yml' --exclude='README.md' --exclude='.gitignore' --exclude='.dockerignore'  --exclude='.github' --exclude='Dockerfile' "$TEMP_DIR/planka-src/" ./
